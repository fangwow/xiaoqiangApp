<template>
    <div class="mssage">
        <div class="l-index-top">
            ...
            <span class="l-top-biaoti">交易明细</span>
            <span class="sp1"></span>
        </div>
        <div class="top-zhanwei"></div>
        <div class="l-mingxi-index">
            <div class="l-mingxi-list">
                <div class="uh">
                    <span class="sp1">会员充值</span>
                    <span class="sp2">2019-1-1</span>
                </div>
                <div class="uh">
                    <span class="sp3">支付宝</span>
                    <span class="sp4">-0.01</span>
                </div>
            </div>
        </div>
    </div>
