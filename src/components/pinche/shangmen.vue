<template>
    <div class="pinche">
        <div class="mineTop">
            ...
            <div v-if="shushi !== 0" class="l-pinche-body">
                ...
                <div style="" class="yinhangka-jia-div1">
                    <div style="" class="yinhangka-jia-div11">
                ...
                <div style="" class="yinhangka-jia-div1">
                    <div style="" class="yinhangka-jia-div11">
                        <span class="sp11">货物属实</span>
                        <div class="uifbuuui">
                            <div class="mui-input-row mui-radio mui-left">
                                <label>是</label>
                                <input @change="is_shushi(1)" name="radio1" type="radio">
                            </div>
                            <div class="mui-input-row mui-radio mui-left">
                                <label>否</label>
                                <input @change="is_shushi(0)" name="radio1" type="radio">
                            </div>
                        </div>
            ...
            <div v-else class="l-pinche-body" >
                <div class="yinhangka-jia-div1">
                    <div class="yinhangka-jia-div11">
                        <span class="sp11">预算运费</span>
                        <input
                ...
                <div class="shangchuan-howu-img">
                    <span class="sp2">上传货物图片</span>
                </div>
                <div class="imgs">
                    ...
                    <span v-if="imgs.length < 3" @click="v_show()"
                          :style="{'height': imgH + 'px', 'width': imgH + 'px'}" id="span0" class="sp1 sp2">
                        <span>添加照片</span>
                    </span>
                </div>
                <div style="height: auto; padding-bottom: 0.2rem" class="yinhangka-jia-div1">
                    <div style="border: none;flex-direction: column; display: flex;" class="yinhangka-jia-div11">
                        <span style="width: 100%" class="sp11">备注</span>
                        <div style="width: 100%" class="sp18">
